...
//System.setProperty("webdriver.gecko.driver", "lib/geckodriver");
        ...
        System.setProperty("webdriver.chrome.driver", "chromedriver.exe");// chromedriver驱动存放地址
        ...
        try {
            /**
             * WebDriver自带了一个智能等待的方法。 driver.manage().timeouts().implicitlyWait(arg0, arg1）；
        ...
        //执行js脚本
        String jString = "alert('给他弹出一个HelloWord')";
